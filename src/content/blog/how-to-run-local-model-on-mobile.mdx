...
pubDate: 'May 2 2026'
heroImage: '/blog/how-to-run-local-model-on-mobile/step-01-play-store.jpg'
...
![Google AI Edge Gallery on the Play Store — tap Install](/blog/how-to-run-local-model-on-mobile/step-01-play-store.png)

## 2. Open the app and pick a use case

Open **Google AI Edge Gallery**. You will see a grid of **use cases** to explore.

![Google AI Edge Gallery home screen showing available use cases](/blog/how-to-run-local-model-on-mobile/step-02-use-cases.png)
...
![List of models available inside AI Chat](/blog/how-to-run-local-model-on-mobile/step-04-model-list.gif)

## 5. Download a model

Tap **Download** on the model card you want. The app will fetch the weights and assets needed for local inference.

![Download button on a model card](/blog/how-to-run-local-model-on-mobile/step-05-download-model.png)
...
![Try it — open the on-device chat after the model is ready](/blog/how-to-run-local-model-on-mobile/step-06-try-it.png)
...
![Chatting with a downloaded model (e.g. Gemma) offline on device](/blog/how-to-run-local-model-on-mobile/step-07a-chat-local.png)
![Chatting with a downloaded model (e.g. Gemma) offline on device](/blog/how-to-run-local-model-on-mobile/step-07b-chat-local.png)
