...
![Chatting with a downloaded model (e.g. Gemma) offline on device 1](/blog/how-to-run-local-model-on-mobile/step-07a-chat-local.png)
![Chatting with a downloaded model (e.g. Gemma) offline on device 2](/blog/how-to-run-local-model-on-mobile/step-07b-chat-local.png)
